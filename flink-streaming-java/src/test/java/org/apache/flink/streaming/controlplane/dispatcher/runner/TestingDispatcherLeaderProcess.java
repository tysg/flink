...
class TestingDispatcherLeaderProcess implements StreamManagerDispatcherLeaderProcess {
	...
	private TestingDispatcherLeaderProcess(
			...
			CompletableFuture<StreamManagerDispatcherGateway> dispatcherGatewayFuture,
	...
	public static class Builder {
		...
		private CompletableFuture<StreamManagerDispatcherGateway> dispatcherGatewayFuture = new CompletableFuture<>();
		...
		public Builder setDispatcherGatewayFuture(CompletableFuture<StreamManagerDispatcherGateway> dispatcherGatewayFuture) {
			this.dispatcherGatewayFuture = dispatcherGatewayFuture;
			return this;
		}
