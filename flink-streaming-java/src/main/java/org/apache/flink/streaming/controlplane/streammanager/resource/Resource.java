...
public class Resource {
	...
	public static class Builder {
		...
		public Resource.Builder setCpuCores(double cpuCores) {
			this.cpuCores = cpuCores;
			return this;
		}

		public Resource.Builder setTaskHeapMemory(long taskHeapMemory) {
			this.taskHeapMemory = taskHeapMemory;
			return this;
		}

		public Resource.Builder setTaskHeapMemoryMB(int taskHeapMemoryMB) {
			this.taskHeapMemory = ((long) taskHeapMemoryMB) << 20;
			return this;
		}

		public Resource.Builder setTaskOffHeapMemory(long taskOffHeapMemory) {
			this.taskOffHeapMemory = taskOffHeapMemory;
			return this;
		}

		public Resource.Builder setTaskOffHeapMemoryMB(int taskOffHeapMemoryMB) {
			this.taskOffHeapMemory = ((long) taskOffHeapMemoryMB) << 20;
			return this;
		}

		public Resource.Builder setManagedMemory(long managedMemory) {
			this.managedMemory = managedMemory;
			return this;
		}

		public Resource.Builder setManagedMemoryMB(int managedMemoryMB) {
			this.managedMemory = ((long) managedMemoryMB) << 20;
			return this;
		}

		public Resource.Builder setNetworkMemory(long networkMemory) {
			this.networkMemory = networkMemory;
			return this;
		}

		public Resource.Builder setNetworkMemoryMB(int networkMemoryMB) {
