...
//			.addAll(Arrays.asList(this.targetVertex.getTaskVertices()));
		...
		this.createCandidates = this.targetVertex.scaleOut(executionGraph.getRpcTimeout(), executionGraph.getGlobalModVersion(), System.currentTimeMillis(), this.targetVertex.getParallelism()+1);
